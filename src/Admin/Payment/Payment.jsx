        ...
        <div className="flex-1 overflow-auto p-4">
          ...
          <div className="w-full">
            <div className="ms-9 mt-4 mb-4">
              <h1 className="text-sm text-gray-600">Admin/Manage Payment/Edit Payment</h1>
              <h3 className="text-3xl font-bold mt-2">PAYMENT</h3>
            </div>
            {/* konten*/}
            <div className="flex row-auto">
              ...
              <div className="flex flex-col gap-4 items-start">
                <div
                  ...
                  onClick={() =>
                    (window.location.href = "/admin/payment/tambahpayment")
                  }
                >
                  Tambah
                </div>
                  ...
                  <tr className="hover:bg-base-300">
                    ...
                    <td className="flex gap-2">
                      <img
                        ...
                        onClick={() =>
                          (window.location.href = "/admin/payment/editpayment")
                        }
                      />
                      <img
                        width="20"
