  ...
  return (
    <div className="max-w-sm mx-auto min-h-screen bg-white border">
      ...
      <div className="flex justify-around py-3 text-sm">
        <span className="text-blue-500 font-semibold border-b-2 border-blue-500 pb-1 cursor-pointer"onClick={() => window.location = "/orderhistory"}>
          Pesan
        </span>
        <span className="text-gray-400 cursor-pointer"onClick={() => window.location = "/reservationhistory"}>Reservasi</span>
      </div>
