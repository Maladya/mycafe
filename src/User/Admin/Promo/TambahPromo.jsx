...
import {
  Coffee, ChevronRight, Plus, Tag, CheckCircle2,
...
export default function TambahPromo() {
  ...
  const removeMenu = (menuId) => {
    setForm((prev) => ({
      ...prev,
      id_menus: prev.id_menus.filter(id => id !== menuId)
    }));
  };
  ...
  const handleReset = () => {
    setForm({ kode_promo: "", status: "Aktif", id_menus: [], berlaku_sampai: "", diskon_persen: "" });
    setMenuSearchQuery("");
  };
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="h-14 bg-white sticky top-0 z-20 flex items-center justify-between px-8 border-b border-gray-200 shadow-sm">
          ...
          <div className="flex items-center gap-1.5 text-xs text-gray-400">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-blue-600 font-bold">Tambah Promo</span>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-auto p-8">
          ...
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <h3 className="text-3xl font-extrabold tracking-tight text-gray-800">Tambah Promo</h3>
              <p className="text-gray-400 text-sm mt-1">Isi formulir untuk menambahkan promo baru</p>
            </div>
            <button
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="px-8 py-5 flex items-center gap-3" style={{ background: "linear-gradient(90deg,#eff6ff,#f8faff)", borderBottom: "1px solid #e0e7ff" }}>
              ...
              <div>
                <p className="font-bold text-gray-800 text-sm">Informasi Promo Baru</p>
                ...
                <div className="flex flex-col gap-5">
                  ...
                  {(form.kode_promo || form.diskon_persen || form.id_menus.length > 0) && (
                    <div className="rounded-xl p-4 border border-blue-100" style={{ background: "#eff6ff" }}>
                      <p className="text-xs font-bold uppercase tracking-wider text-blue-400 mb-3">Preview Promo</p>
                    ...
                    <div className="flex-1 flex items-center justify-center">
                      <div className="text-center py-12">
                        <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: "#eff6ff" }}>
                          <Utensils className="w-8 h-8 text-blue-300" />
                        </div>
                        <p className="text-sm text-gray-400 mb-2">Belum ada menu dipilih</p>
                        <p className="text-xs text-gray-300">Pilih menu untuk melihat detail harga</p>
                      </div>
                    </div>
                  )}
                </div>
