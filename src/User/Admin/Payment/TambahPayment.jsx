...
import {
  Coffee, ChevronRight, Plus, CreditCard, Wallet, Building2,
...
export default function TambahPayment() {
  ...
  const handleReset = () => setForm({ idTransaksi: "", tipe: "", status: "", aktif: true });
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="h-14 bg-white sticky top-0 z-20 flex items-center justify-between px-8 border-b border-gray-200 shadow-sm">
          ...
          <div className="flex items-center gap-1.5 text-xs text-gray-400">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-blue-600 font-bold">Tambah Payment</span>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-auto p-8">
          ...
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <h3 className="text-3xl font-extrabold tracking-tight text-gray-800">Tambah Payment</h3>
              <p className="text-gray-400 text-sm mt-1">Isi formulir untuk menambahkan metode pembayaran baru</p>
            </div>
            <button
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="px-8 py-5 flex items-center gap-3" style={{ background: "linear-gradient(90deg,#eff6ff,#f8faff)", borderBottom: "1px solid #e0e7ff" }}>
              ...
              <div>
                <p className="font-bold text-gray-800 text-sm">Informasi Payment Baru</p>
                <p className="text-xs text-gray-400">Lengkapi semua field yang diperlukan</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between px-4 py-3.5 rounded-2xl border transition-all" style={form.aktif ? { background: "#f8faff", borderColor: "#e0e7ff" } : { background: "#f9fafb", borderColor: "#f1f5f9" }}>
                      <div>
                      ...
                      >
                        <div className="absolute top-0.5 w-5 h-5 rounded-full bg-white shadow-sm transition-all" style={{ left: form.aktif ? "calc(100% - 22px)" : "2px" }} />
                      </button>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-5">
                      ...
                      {STATUS_OPTIONS.map((s) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {active && (
                              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-bold" style={{ background: s.color + "20", color: s.color }}>
                  ...
                  {/* Preview Card */}
                  {(form.idTransaksi || form.tipe || form.status) && (
                    <div className="rounded-xl p-4 border border-blue-100 mt-2" style={{ background: "#eff6ff" }}>
                      <p className="text-xs font-bold uppercase tracking-wider text-blue-400 mb-3">Preview Data</p>
